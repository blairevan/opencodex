...
export const ko: Record<TKey, string> = {
  ...
  "antigravityPool.title": "Google Antigravity 계정 풀 (실험적)",
  "antigravityPool.enabledDesc": "429 발생 시 계정을 쿨다운하고 장애 조치합니다. 새 세션은 사용량 {threshold}% 미만 계정을 선호합니다.",
  "antigravityPool.disabledDesc": "현재 활성 Google 계정만 사용합니다.",
  "antigravityPool.experimentalWarning": "실험적 기능입니다. Google 계정별 Cloud Code Assist 할당량은 독립적이며, 활성화 시 자동 장애 조치를 제공합니다.",
  "antigravityPool.needTwoAccounts": "풀을 활성화하기 전에 Google OAuth 계정을 2개 이상 추가하세요.",
  "antigravityPool.threshold": "새 세션 사용량 임계값",
  "antigravityPool.thresholdAria": "새 세션 사용량 임계값(%)",
  "antigravityPool.thresholdHelp": "0은 할당량 기반 선택을 비활성화합니다. 기본값 80.",
  "antigravityPool.thresholdInvalid": "0에서 100 사이의 정수를 입력하세요",
  "antigravityPool.loadFailed": "Google Antigravity 풀 설정을 불러오지 못했습니다.",
  "antigravityPool.saveFailed": "Google Antigravity 풀 설정을 저장하지 못했습니다.",
  "antigravityPool.on": "켜짐",
  "antigravityPool.off": "꺼짐",
  ...
  "quota.resetsRelativeMinutes": "{n}분 후 초기화 [{time}]",
  "quota.resetsRelativeHours": "{n}시간 후 초기화 [{time}]",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.availableAccountsCount": "사용 가능한 계정 [{available}/{total}]",
  "pws.accountStatus.normal": "정상: {count}",
  "pws.accountStatus.disabled": "수동 비활성화: {count}",
  "pws.accountStatus.reauth": "재로그인 필요: {count}",
  "pws.accountStatus.restricted": "제한됨: {count}",
  "pws.accountStatus.unavailable": "할당량을 사용할 수 없음: {count}",
  "pws.showAccountInfo": "계정 정보 표시",
  ...
  "pws.accountEnabled": "사용",
  "pws.accountDisabled": "사용 안 함",
  "pws.accountEnableFailed": "계정 상태를 업데이트하지 못했습니다.",
  "pws.expandAllAccounts": "모두 펼치기",
  "pws.collapseAllAccounts": "모두 접기",
  "pws.expandAccount": "펼치기",
  "pws.collapseAccount": "접기",
