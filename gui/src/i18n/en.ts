...
export const en = {
  ...
  "quota.resetsRelativeMinutes": "Resets in {n} min [{time}]",
  "quota.resetsRelativeHours": "Resets in {n} h [{time}]",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.accountEnabled": "Enabled",
  "pws.accountDisabled": "Disabled",
  "pws.accountEnableFailed": "Could not update account status.",
  "pws.expandAllAccounts": "Expand all",
  "pws.collapseAllAccounts": "Collapse all",
  "pws.expandAccount": "Expand",
  "pws.collapseAccount": "Collapse",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "antigravityPool.title": "Google Antigravity account pool (experimental)",
  "antigravityPool.enabledDesc": "On 429, cools the account and fails over. New sessions prefer usage under {threshold}% (model family quota).",
  "antigravityPool.disabledDesc": "Uses only the active Google account. Enable to automatically rotate across logged-in Google accounts.",
  "antigravityPool.experimentalWarning": "Experimental feature. Multi-account rotation occurs only on 429 rate limits or quota exhaustion. Cloud Code Assist quotas are per-account; enabling this distributes usage and provides automatic failover.",
  "antigravityPool.needTwoAccounts": "Add at least two Google OAuth accounts before enabling the pool.",
  "antigravityPool.threshold": "New-session usage threshold",
  "antigravityPool.thresholdAria": "New-session usage threshold, percent",
  "antigravityPool.thresholdHelp": "0 disables quota-based picking (affinity + active account only). Default 80.",
  "antigravityPool.thresholdInvalid": "Enter a whole number from 0 to 100",
  "antigravityPool.loadFailed": "Google Antigravity pool settings could not be loaded.",
  "antigravityPool.saveFailed": "Google Antigravity pool settings could not be saved.",
  "antigravityPool.on": "On",
  "antigravityPool.off": "Off",
