...
export const ja: Record<TKey, string> = {
  ...
  "quota.resetsRelativeMinutes": "{n} 分後にリセット [{time}]",
  "quota.resetsRelativeHours": "{n} 時間後にリセット [{time}]",
  ...
  "pws.availableAccountsCount": "利用可能なアカウント [{available}/{total}]",
  "pws.accountStatus.normal": "正常: {count}",
  "pws.accountStatus.disabled": "手動で無効: {count}",
  "pws.accountStatus.reauth": "再ログインが必要: {count}",
  "pws.accountStatus.restricted": "制限中: {count}",
  "pws.accountStatus.unavailable": "クォータ利用不可: {count}",
  "pws.showAccountInfo": "アカウント情報を表示",
  ...
  "pws.accountEnabled": "有効",
  "pws.accountDisabled": "無効",
  "pws.accountEnableFailed": "アカウント状態を更新できませんでした。",
  "pws.expandAllAccounts": "すべて展開",
  "pws.collapseAllAccounts": "すべて折りたたむ",
  "pws.expandAccount": "展開",
  "pws.collapseAccount": "折りたたむ",
  ...
  "antigravityPool.title": "Google Antigravity アカウントプール（実験的）",
  "antigravityPool.enabledDesc": "429 発生時にアカウントをクールダウンしてフェイルオーバーします。新規セッションは使用量 {threshold}% 未満のアカウントを優先します。",
  "antigravityPool.disabledDesc": "現在アクティブな Google アカウントのみを使用します。",
  "antigravityPool.experimentalWarning": "実験的機能です。各 Google アカウントの Cloud Code Assist クォータは独立しており、有効にすると負荷分散と自動フェイルオーバーが行われます。",
  "antigravityPool.needTwoAccounts": "プールを有効にする前に、少なくとも2つの Google OAuth アカウントを追加してください。",
  "antigravityPool.threshold": "新規セッション使用量しきい値",
  "antigravityPool.thresholdAria": "新規セッション使用量しきい値（％）",
  "antigravityPool.thresholdHelp": "0 でクォータベースの選択を無効化（親和性 + アクティブアカウントのみ）。デフォルト 80。",
  "antigravityPool.thresholdInvalid": "0 から 100 までの整数を入力してください",
  "antigravityPool.loadFailed": "Google Antigravity プール設定を読み込めませんでした。",
  "antigravityPool.saveFailed": "Google Antigravity プール設定を保存できませんでした。",
  "antigravityPool.on": "オン",
  "antigravityPool.off": "オフ",
