...
export const ru: Record<TKey, string> = {
  ...
  "quota.resetsRelativeMinutes": "Сброс через {n} мин [{time}]",
  "quota.resetsRelativeHours": "Сброс через {n} ч [{time}]",
  ...
  "pws.availableAccountsCount": "Доступные аккаунты [{available}/{total}]",
  "pws.accountStatus.normal": "В норме: {count}",
  "pws.accountStatus.disabled": "Отключены вручную: {count}",
  "pws.accountStatus.reauth": "Требуется повторный вход: {count}",
  "pws.accountStatus.restricted": "Ограничены: {count}",
  "pws.accountStatus.unavailable": "Квота недоступна: {count}",
  "pws.showAccountInfo": "Показывать данные аккаунта",
  ...
  "pws.interval1m": "1 мин",
  "pws.interval3m": "3 мин",
  ...
  "pws.accountEnabled": "Включён",
  "pws.accountDisabled": "Отключён",
  "pws.accountEnableFailed": "Не удалось обновить состояние аккаунта.",
  "pws.expandAllAccounts": "Развернуть все",
  "pws.collapseAllAccounts": "Свернуть все",
  "pws.expandAccount": "Развернуть",
  "pws.collapseAccount": "Свернуть",
  ...
  "antigravityPool.title": "Пул аккаунтов Google Antigravity (экспериментальный)",
  "antigravityPool.enabledDesc": "При 429 переводит аккаунт в кулдаун и переключает. Новые сессии предпочитают использование ниже {threshold}%.",
  "antigravityPool.disabledDesc": "Использует только активный аккаунт Google Antigravity.",
  "antigravityPool.experimentalWarning": "Экспериментальная функция. Квоты Cloud Code Assist независимы для каждого аккаунта Google; включение обеспечивает автоматическое переключение.",
  "antigravityPool.needTwoAccounts": "Добавьте как минимум два аккаунта Google OAuth перед включением пула.",
  "antigravityPool.threshold": "Порог использования для новых сессий",
  "antigravityPool.thresholdAria": "Порог использования для новых сессий, процент",
  "antigravityPool.thresholdHelp": "0 отключает выбор по квоте. По умолчанию 80.",
  "antigravityPool.thresholdInvalid": "Введите целое число от 0 до 100",
  "antigravityPool.loadFailed": "Не удалось загрузить настройки пула Google Antigravity.",
  "antigravityPool.saveFailed": "Не удалось сохранить настройки пула Google Antigravity.",
  "antigravityPool.on": "Вкл",
  "antigravityPool.off": "Выкл",
