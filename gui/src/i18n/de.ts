...
export const de: Record<TKey, string> = {
  ...
  "antigravityPool.title": "Google Antigravity Kontopool (experimentell)",
  "antigravityPool.enabledDesc": "Bei 429 wird das Konto abgekühlt und gewechselt. Neue Sitzungen bevorzugen eine Nutzung unter {threshold}%.",
  "antigravityPool.disabledDesc": "Verwendet nur das aktive Google Antigravity-Konto.",
  "antigravityPool.experimentalWarning": "Experimentelle Funktion. Cloud Code Assist-Kontingente sind pro Google-Konto unabhängig.",
  "antigravityPool.needTwoAccounts": "Fügen Sie mindestens zwei Google OAuth-Konten hinzu, bevor Sie den Pool aktivieren.",
  "antigravityPool.threshold": "Nutzungsschwelle für neue Sitzungen",
  "antigravityPool.thresholdAria": "Nutzungsschwelle für neue Sitzungen in Prozent",
  "antigravityPool.thresholdHelp": "0 deaktiviert die kontingentbasierte Auswahl. Standard: 80.",
  "antigravityPool.thresholdInvalid": "Geben Sie eine ganze Zahl von 0 bis 100 ein",
  "antigravityPool.loadFailed": "Google Antigravity-Pooleinstellungen konnten nicht geladen werden.",
  "antigravityPool.saveFailed": "Google Antigravity-Pooleinstellungen konnten nicht gespeichert werden.",
  "antigravityPool.on": "Ein",
  "antigravityPool.off": "Aus",
  ...
  "quota.resetsRelativeMinutes": "Zurücksetzung in {n} Min. [{time}]",
  "quota.resetsRelativeHours": "Zurücksetzung in {n} Std. [{time}]",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.availableAccountsCount": "Verfügbare Konten [{available}/{total}]",
  "pws.accountStatus.normal": "Normal: {count}",
  "pws.accountStatus.disabled": "Manuell deaktiviert: {count}",
  "pws.accountStatus.reauth": "Erneute Anmeldung erforderlich: {count}",
  "pws.accountStatus.restricted": "Eingeschränkt: {count}",
  "pws.accountStatus.unavailable": "Kontingent nicht verfügbar: {count}",
  "pws.showAccountInfo": "Kontoinformationen anzeigen",
  ...
  "pws.accountEnabled": "Aktiv",
  "pws.accountDisabled": "Deaktiviert",
  "pws.accountEnableFailed": "Kontostatus konnte nicht aktualisiert werden.",
  "pws.expandAllAccounts": "Alle ausklappen",
  "pws.collapseAllAccounts": "Alle einklappen",
  "pws.expandAccount": "Ausklappen",
  "pws.collapseAccount": "Einklappen",
