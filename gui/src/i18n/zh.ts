...
export const zh: Record<TKey, string> = {
  ...
  "antigravityPool.title": "Google Antigravity 账户池（实验性）",
  "antigravityPool.enabledDesc": "遇到 429 时冷却该账户并故障转移。新会话优先使用模型家族配额低于 {threshold}% 的账户。",
  "antigravityPool.disabledDesc": "仅使用当前活跃的 Google 账户。启用后可在多个已登录 Google 账号间自动切换。",
  "antigravityPool.experimentalWarning": "实验性功能。多账号自动轮换仅在遇到 429 或配额耗尽时发生。每个 Google 账号的 Cloud Code Assist 配额相互独立，开启后可自动实现用量分摊与故障转移。",
  "antigravityPool.needTwoAccounts": "启用账户池前请至少添加两个 Google OAuth 账户。",
  "antigravityPool.threshold": "新会话用量阈值",
  "antigravityPool.thresholdAria": "新会话用量阈值（百分比）",
  "antigravityPool.thresholdHelp": "0 表示禁用基于配额的选择（仅亲和性 + 活跃账户）。默认 80。",
  "antigravityPool.thresholdInvalid": "请输入 0 到 100 之间的整数",
  "antigravityPool.loadFailed": "无法加载 Google Antigravity 账户池设置。",
  "antigravityPool.saveFailed": "无法保存 Google Antigravity 账户池设置。",
  "antigravityPool.on": "开",
  "antigravityPool.off": "关",
  ...
  "quota.resetsRelativeMinutes": "{n} 分钟后重置 [{time}]",
  "quota.resetsRelativeHours": "{n} 小时后重置 [{time}]",
  "pws.status.ready": "就绪",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.availableAccountsCount": "可用账户[{available}/{total}]",
  "pws.accountStatus.normal": "正常：{count}",
  "pws.accountStatus.disabled": "手动停用：{count}",
  "pws.accountStatus.reauth": "需要重新登录：{count}",
  "pws.accountStatus.restricted": "被限制：{count}",
  "pws.accountStatus.unavailable": "额度不可用：{count}",
  "pws.showAccountInfo": "展示账号信息",
  ...
  "pws.accountEnabled": "启用",
  "pws.accountDisabled": "停用",
  "pws.accountEnableFailed": "更新账户状态失败。",
  "pws.expandAllAccounts": "全部展开",
  "pws.collapseAllAccounts": "全部收起",
  "pws.expandAccount": "展开",
  "pws.collapseAccount": "收起",
